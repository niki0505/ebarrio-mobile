        ...
        <View style={MyStyles.loginWrapper}>
          ...
          >
            ...
            >
              ...
              <View>
                <Text style={MyStyles.termsTitle}>2. Account Registration</Text>
                <Text style={MyStyles.termsDesc}>
              ...
              <View>
                ...
                <Text style={MyStyles.termsDesc}>
                  Using our services means that your session will remain active
                  for a period of 30 days from the moment you log in. Your
                  session will continue without interruption until you manually
                  log out. You are responsible for logging out when you are no
                  longer using the application to ensure the security of your
                  account. After 30 days, your session will automatically expire
                  requiring you to login again to continue using our services.
                </Text>
              </View>
              ...
              <View>
                ...
                <Text style={MyStyles.termsDesc}>
                  By enabling notifications for this application, you consent to
                  receiving important updates, alerts, and emergency-related
                  communications. These notifications may include, but are not
                  limited to: - Barangay announcements - Request Status Updates
              ...
              <View>
                ...
                <Text style={MyStyles.termsDesc}>
                  By using this application, you grant permission for the app to
                  access the location of your device in the event of an SOS
                  emergency. Your location is collected and used in accordance
                  with our Privacy Policy. You can revoke location access at any
                  time by changing the permissions in your device settings.
                </Text>
              </View>
              ...
              <View>
                ...
                <Text style={MyStyles.termsDesc}>
                  The App allows residents to access emergency protocols, report
                  emergencies, and receive updates. By using these features, you
                  agree to: {"\n"} - Provide accurate and truthful information
                  when reporting incidents or emergencies. {"\n"} - Acknowledge
                  that any misuse of disaster response features could lead to
                  delays or errors in the delivery of essential services.
                </Text>
              </View>
              ...
              <View>
                ...
                <Text style={MyStyles.termsDesc}>
                  ...
                  that are not within our control. We are not liable for the
                  content, privacy policies, or services offered by these third
                  parties. We recommend reviewing the terms and conditions for
              ...
              <View>
                ...
                <Text style={MyStyles.termsDesc}>
                  If you violate these Terms of Service or engage in misconduct,
                  we may suspend or terminate your access to the App. Upon
                  termination, all rights granted to you under these terms will
                  be terminated, and you must stop using the App.
                </Text>
              </View>

              <View>
                <Text style={MyStyles.termsTitle}>16. Contact Information</Text>
                <Text style={MyStyles.termsDesc}>
